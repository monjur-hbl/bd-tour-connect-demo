...
// Messaging icon component (chat bubbles)
const MessagingIcon = () => (
...
interface NavItem {
  ...
  badge?: 'whatsapp'; // Special badge types
}
          ...
          {getNavItems().map((item) => (
            <li key={item.href}>
              ...
              >
                ...
                {item.badge === 'whatsapp' && unreadTotal > 0 && (
                  <span className="min-w-[20px] h-5 px-1.5 bg-green-500 text-white text-xs font-medium rounded-full flex items-center justify-center">
